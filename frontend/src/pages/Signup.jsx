    ...
    <div className="min-h-screen bg-[#f5f5f5]">
      ...
      <div className="flex justify-center items-center h-[calc(100vh-4rem)]">
        <div className="bg-white shadow-md rounded-lg p-8 w-96">
          ...
          <h2 className="mb-6 text-center">Join now to be a 100x developer!</h2>
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[#443dff] text-white py-2 rounded-md font-medium hover:bg-[#322ecc]">Join Now
            </button>
          </form>
        </div>
      </div>
